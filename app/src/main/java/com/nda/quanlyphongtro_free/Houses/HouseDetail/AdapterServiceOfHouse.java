...
public class AdapterServiceOfHouse extends RecyclerView.Adapter<AdapterServiceOfHouse.HolderAddHouse> {
    HouseDetailSystem context;
    List<Service> serviceList;

    public AdapterServiceOfHouse(HouseDetailSystem context, List<Service> serviceList) {
