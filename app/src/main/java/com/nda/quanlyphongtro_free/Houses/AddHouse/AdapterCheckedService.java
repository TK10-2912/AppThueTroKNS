...
public class AdapterCheckedService extends RecyclerView.Adapter<AdapterCheckedService.HolderServices> {
    AddHouse context;
    List<Service> checkedServiceList;

    public AdapterCheckedService(AddHouse context, List<Service> checkedServiceList) {
    ...
    @NonNull
    @Override
    public AdapterCheckedService.HolderServices onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_checked_services, parent,false);
        return new AdapterCheckedService.HolderServices(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterCheckedService.HolderServices holder, int position) {
